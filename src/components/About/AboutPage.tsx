...
export default function AboutPage() {
  ...
  return (
    <main className="pt-16">
      <SEO
        title="About Nimble - Expert Business Consulting Team"
        description="Meet the Nimble team: Former Fortune 500 executives, CPAs, and marketing experts dedicated to helping 500+ entrepreneurs launch and grow successful businesses."
      />
      {/* Hero */}
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            ...
            alt="Team collaboration and business consulting"
