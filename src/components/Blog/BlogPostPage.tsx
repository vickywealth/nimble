...
import { ArrowLeft, Clock, User, Calendar, Share2, Bookmark, ChevronLeft, ChevronRight } from 'lucide-react'

// Import posts data from BlogPage
const posts = [
  { 
  ...
  { 
    ...
    color: 'hsl(221,83%,53%)',
    image: 'https://images.unsplash.com/photo-1450158885227-28128e9eb245?w=1200&h=800&fit=crop',
    ...
    <main className="pt-16">
      ...
      <section className="relative h-[50vh] min-h-[400px] overflow-hidden">
        ...
        <button
          ...
          className="absolute top-8 left-8 flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white/20 transition-colors"
        >
        ...
        <div className="absolute bottom-0 left-0 right-0 section-container pb-12">
          <span 
            className="inline-flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-full bg-white/95 backdrop-blur-sm mb-4"
      ...
      <section className="section-padding bg-white">
        <div className="section-container max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {prevPost && (
                <button
                  ...
                  className="flex items-start gap-4 p-6 rounded-2xl border border-border hover:border-primary/30 hover:bg-accent transition-all text-left group"
                >
                  <ChevronLeft className="w-5 h-5 text-muted-foreground mt-1 group-hover:text-primary transition-colors" />
                  <div>
              ...
              {nextPost && (
                <button
                  ...
                  className="flex items-start gap-4 p-6 rounded-2xl border border-border hover:border-primary/30 hover:bg-accent transition-all text-left group md:ml-auto"
                >
          ...
          {/* CTA */}
          <div className="mt-12 rounded-3xl hero-bg p-8 text-center">
            <h3 className="text-2xl font-bold text-white mb-3">
              Ready to Put These Insights Into Action?
            </h3>
            <p className="text-white/80 mb-6 max-w-xl mx-auto">
              Book a free consultation with our team and let's build your business strategy together.
            </p>
