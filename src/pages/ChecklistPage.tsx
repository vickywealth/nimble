        ...
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                        <span className={`text-base font-semibold transition-colors ${isChecked ? 'line-through text-muted-foreground' : 'text-foreground'}`}>
                          {item.title}
                        </span>
            ...
            <div className="space-y-6">
              {/* Progress */}
              <div className="bg-white rounded-3xl border border-border shadow-card p-6 animate-on-scroll sticky top-24">
                <div className="text-center mb-5">
                  <div className="relative w-28 h-28 mx-auto mb-3">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center flex-col">
                      <span className="text-3xl font-bold" style={{ color: 'hsl(var(--primary))' }}>{progress}%</span>
                      <span className="text-xs text-muted-foreground">Complete</span>
                    </div>
                  </div>
                  <h3 className="font-bold text-foreground">Your Progress</h3>
                  <p className="text-sm text-muted-foreground mt-1">
                    {progress === 100 ? '🎉 You\'re ready to launch!' : `${10 - checked.size} steps remaining`}
                  </p>
                </div>

                {progress === 100 && (
                  <div className="rounded-2xl p-4 text-center mb-4"
                    style={{ background: 'hsl(142, 71%, 45%, 0.1)', border: '1px solid hsl(142, 71%, 45%, 0.25)' }}>
                    <Trophy className="w-6 h-6 mx-auto mb-2" style={{ color: 'hsl(142, 71%, 45%)' }} />
                    <p className="text-sm font-semibold" style={{ color: 'hsl(142, 71%, 45%)' }}>
                      Congratulations! Your business is ready to launch.
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/book" className="btn-primary w-full justify-center text-sm py-3">
                    Get Help Completing These
              ...
              {/* Download Guide */}
              <div className="rounded-3xl p-6 hero-bg animate-on-scroll" style={{ animationDelay: '0.2s' }}>
                <Download className="w-8 h-8 text-white mb-4" />
                <h3 className="font-bold text-white mb-2">Free Startup Guide</h3>
                <p className="text-white/75 text-sm leading-relaxed mb-5">
                  Download our comprehensive 40-page startup guide with templates, checklists, and expert tips.
                </p>
                <button className="btn-white w-full justify-center text-sm py-3">
              ...
              {/* Category Legend */}
              <div className="bg-white rounded-3xl border border-border shadow-card p-6 animate-on-scroll" style={{ animationDelay: '0.3s' }}>
